...
$(document).ready(function() {
  ...
  $("tbody input").click(function() {
    $(this).closest("table").find("thead input.all").attr("checked", $(this).closest("table tbody").find("input:checked").length == $(this).closest("table").find("tbody input").length)
  });
  
  $("thead input.all").click(function() {
    $(this).closest("table").find("tbody input").attr("checked", $(this).attr("checked") == "checked")
  });
